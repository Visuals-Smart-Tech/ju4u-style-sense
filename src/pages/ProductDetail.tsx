...
const getProductTryOnType = (product: Product): 'hats' | 'tops' | 'glasses' | 'accessories' | undefined => {
...
const getProductFitType = (product: Product): 'tops' | 'bottoms' | 'dresses' | 'outerwear' | 'shoes' | 'accessories' => {
